...
include::_developer-guide/Scoped_Jakarta_Enterprise_Beans_client_contexts.adoc[]

include::_developer-guide/Jakarta_Enterprise_Beans_invocations_from_a_remote_client_using_JNDI.adoc[]

include::_developer-guide/Jakarta_Enterprise_Beans_invocations_from_a_remote_server_instance.adoc[]

include::_developer-guide/Remote_Jakarta_Enterprise_Beans_invocations_via_JNDI_-_Jakarta_Enterprise_Beans_client_API_or_wildfly-naming-client_project.adoc[]
